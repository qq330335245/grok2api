  ...
  "zh-CN": {
    translation: {
      ...
      antidegrade: {
        ...
        clearedAccount: "已解除账号隔离", clearedIp: "已解除出口冷却",
        events: "最近事件", noEvents: "暂无事件", eventOk: "有思考", eventMiss: "无思考",
        reasons: { dirty_ip: "脏口", farm: "农场口", density: "密度", k_ip_no_streamed_thinking: "失败出口达阈值" },
  ...
  en: {
    translation: {
      ...
      antidegrade: {
        ...
        clearedAccount: "Account quarantine cleared", clearedIp: "ExitIP cooldown cleared",
        events: "Recent events", noEvents: "No events", eventOk: "Thinking", eventMiss: "No thinking",
        reasons: { dirty_ip: "Dirty IP", farm: "Farm IP", density: "Density", k_ip_no_streamed_thinking: "Fail-exit threshold" },
