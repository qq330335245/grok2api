  ...
  "zh-CN": {
    translation: {
      ...
      antidegrade: {
        ...
        summary: "{{mode}} · 窗口 {{window}} · 每口 {{cap}} · 失败出口 {{threshold}}",
        ...
        enabled: "启用", mode: "模式", densityWindow: "密度窗口", densityMaxAccounts: "每口账号上限",
  ...
  en: {
    translation: {
      ...
      antidegrade: {
        ...
        summary: "{{mode}} · window {{window}} · cap {{cap}} · fail-exit {{threshold}}",
        ...
        enabled: "Enabled", mode: "Mode", densityWindow: "Density window", densityMaxAccounts: "Accounts per ExitIP",
