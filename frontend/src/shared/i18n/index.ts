  ...
  "zh-CN": {
    translation: {
      ...
      antidegrade: {
        ...
        scopeHelp: "未勾选的渠道原样转发", coolingHelp: "密度窗口内冷却中的 ExitIP", quarantineHelp: "因连续无思考被隔离的账号",
        ...
        failedIps: "失败出口", until: "至 {{time}}", clearAccount: "解除隔离", clearIp: "解除冷却",
        ...
        failExitThreshold: "失败出口阈值", failExitHelp: "同一账号在多少条不同 ExitIP 上仍无明文思考后进入隔离。",
  ...
  en: {
    translation: {
      ...
      antidegrade: {
        ...
        scopeHelp: "Unchecked channels pass through unchanged", coolingHelp: "ExitIPs cooling in the density window", quarantineHelp: "Accounts isolated after repeated missing thinking",
        ...
        failedIps: "Failed exits", until: "Until {{time}}", clearAccount: "Lift quarantine", clearIp: "Lift cooldown",
        ...
        failExitThreshold: "Fail-exit threshold", failExitHelp: "Distinct ExitIPs without streamed thinking before the account is quarantined.",
