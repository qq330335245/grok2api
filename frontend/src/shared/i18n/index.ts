...
Object.assign(resources["zh-CN"].translation.accounts as unknown as Record<string, unknown>, {
  ...
  detectBotFlagAllDescription: "对每个 Build 号用粘性 {account}+n 换口打思考请求：全部无思考视为号级风控。不走 grok-4.5 探活，不标失效，不需要 SSO。",
  detectBotFlagSelectedTitle: "检测选中的 {{count}} 个账号风控？",
  detectBotFlagSelectedDescription: "对选中的 Build 号用粘性 {account}+n 换口打思考请求：全部无思考视为号级风控。不走 grok-4.5 探活，不标失效，不需要 SSO。",
...
Object.assign(resources.en.translation.accounts as unknown as Record<string, unknown>, {
  ...
  detectBotFlagAllDescription: "Probe each Build account on sticky {account}+n exits. No streamed thinking on every attempt means account-level bot risk. This does not run the grok-4.5 liveness probe, mark credentials invalid, or require SSO.",
  detectBotFlagSelectedTitle: "Detect bot risk for {{count}} selected accounts?",
  detectBotFlagSelectedDescription: "Probe selected Build accounts on sticky {account}+n exits. No streamed thinking on every attempt means account-level bot risk.",
