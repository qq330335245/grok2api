  ...
  en: {
    translation: {
      ...
      antidegrade: {
        ...
        loadHelp: "The bar is unique accounts that used this ExitIP in the density window, not live connections.",
        ...
        noIps: "No ExitIPs with window load or an active cooldown.",
