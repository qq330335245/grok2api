...
const endpoints: Record<string, EndpointDefinition> = {
  ...
  "image/edits": {
    ...
    fields: [
      ...
      { name: "mask", descriptionKey: "docs.reference.fieldEditMask" },
      { name: "selection_regions", descriptionKey: "docs.reference.fieldSelectionRegions" },
      { name: "n", descriptionKey: "docs.reference.fieldImageCount" },
      { name: "quality", descriptionKey: "docs.reference.fieldQuality" },
      { name: "response_format", descriptionKey: "docs.reference.fieldResponseFormat" },
    ],
    noteKeys: ["docs.reference.noteEditJSON", "docs.reference.noteEditMask", "docs.reference.noteEditSources", "docs.reference.noteImageStorage"],
